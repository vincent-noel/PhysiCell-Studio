...
from physiboss_intra import PhysiBoSS_CellDef
...
class CellDef(StudioTab):
    def __init__(self, xml_creator):
        ...
        self.physiboss_boolean_frame = PhysiBoSS_CellDef(None, None, self)
...
"""
    ...
    def fill_substrates_comboboxes(self):
        ...
        self.physiboss_boolean_frame.physiboss_update_list_signals()
        self.physiboss_boolean_frame.physiboss_update_list_behaviours()
    ...
    def update_intracellular_params(self):
        ...
        if self.param_d[cdname]["intracellular"] is not None:
            if self.param_d[cdname]["intracellular"]["type"] == "maboss":
                print("------ Parsing physiboss intracellular params")
                self.physiboss_boolean_frame.fill_gui(cdname)
    ...
    def fill_xml_intracellular(self, pheno, cdef):
        ...
        if self.param_d[cdef]['intracellular'] is not None:
            ...
            if self.param_d[cdef]['intracellular']['type'] == "maboss":
                self.physiboss_boolean_frame.fill_xml(pheno, cdef)
